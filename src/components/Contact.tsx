...
const Contact = () => {
    return (
        <div id="contact" className="my-20 min-h-96 w-screen bg-black px-10">
            <div className="relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden">
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <AnimatedTitle
                        ...
                        containerClass="special-font !md:text-[6.2rem] w-full font-zentry !text-5xl !font-black !leading-[0.9]"
                    />
